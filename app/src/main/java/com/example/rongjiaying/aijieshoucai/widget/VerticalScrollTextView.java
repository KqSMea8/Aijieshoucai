package com.example.rongjiaying.aijieshoucai.widget;
...
public class VerticalScrollTextView extends RelativeLayout {
    ...
    private void autoSlider() {
        ...
        if (onSelectItemPosition != null) {
            onSelectItemPosition.onSelectItemPosition(mCurrentItemIndex);
        }
    ...
    public void setOnSelectItemPosition(OnSelectItemPosition onSelectItemPosition) {
        this.onSelectItemPosition = onSelectItemPosition;
    }

    //监听滚动到第几个
    OnSelectItemPosition onSelectItemPosition;

    public interface OnSelectItemPosition {
        void onSelectItemPosition(int position);
    }
}