...
import com.example.rongjiaying.aijieshoucai.imageloader.BoxingGlideLoader;
...
public class JGApplication extends com.activeandroid.app.Application {
    ...
    public ArrayList<AppCompatActivity> activities;
    @Override
    public void onCreate() {
        ...
        IBoxingMediaLoader iBoxingMediaLoader = new BoxingGlideLoader();
        BoxingMediaLoader.getInstance().init(iBoxingMediaLoader);
