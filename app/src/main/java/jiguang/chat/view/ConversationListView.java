...
import com.example.rongjiaying.aijieshoucai.widget.MyListView;
...
public class ConversationListView {
    ...
    private MyListView mConvListView = null;
    ...
    public void initModule() {
        mConvListView = (MyListView) mConvListFragment.findViewById(R.id.conv_list_view);
